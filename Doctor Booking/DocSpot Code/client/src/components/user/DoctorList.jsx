...
const DoctorList = ({ userDoctorId, doctor, userdata }) => {
  ...
  const handleBook = async (e) => {
    ...
    try {
      ...
      if (res.data.success) {
        message.success(res.data.message || 'Appointment requested successfully!');
        handleClose();
      } else {
    ...
    <>
      <Card style={{ width: '18rem', margin: '10px auto' }}>
        <Card.Body>
          ...
          <Card.Text>
            <p>
              Timing: <b>{doctor.timings[0]} – {doctor.timings[1]}</b>
            </p>
          </Card.Text>
                ...
                <Row className="mb-3">
                  <Col md={{ span: 10, offset: 1 }}>
                    ...
                    <Form.Group controlId="formFileSm" className="mb-3">
                      <Form.Label>Relevant document (optional)</Form.Label>
